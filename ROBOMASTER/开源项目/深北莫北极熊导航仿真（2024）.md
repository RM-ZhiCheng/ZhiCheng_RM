...
标题: 深北莫北极熊导航仿真（2024）
类型: 开源项目 README
来源: https://github.com/LihanChen2004/pb_rm_simulation
复制日期: 2026-09-18
备注: Gazebo + FAST_LIO/Point_LIO + Nav2 仿真，2024 赛季
整理: 郑邦合（AI 整理）
---
...
|:-:|:-:|
|![Gazebo 仿真](附件/北极熊-仿真效果.png)|![Fast_LIO/Point_LIO + Navigation2](附件/北极熊-FASTLIO与Nav2.png)|

|动态避障|
|:-:|
|![Gazebo 仿真](附件/北极熊-动态避障.gif)|

|一键偷家|
|:-:|
|![Gazebo 仿真](附件/北极熊-轨迹跟踪一键偷家.gif)|
